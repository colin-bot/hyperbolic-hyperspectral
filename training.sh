...
python3 train_convnet.py --dataset_label_type brix --n_epochs 30 --lr 0.00001  --classification --resnet --n_bins 10 --seed 7 --plot_preds --eval_only --gradcam
...
# python3 train_convnet.py --dataset_label_type brix --classification --n_bins 10 --n_epochs 10 --lr 0.001 --hypll --seed 2 --pooling_factor 4 --pooling_func min --plot_preds
