...
python3 train_hypcv.py --n_epochs 30 --lr 0.005 --seed 333 --dataset_label_type brix \
        --n_bins 4 --combined_loss --blur_labels --plot_preds --num_layers 18 --embedding_dim 32 \
        --encoder_manifold euclidean --decoder_manifold lorentz --encoder_k 1.0 --decoder_k 1.0 \
